#
#  Be sure to run `pod spec lint RxMVVM.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "Rx based MVVM pattern implementation"

  spec.homepage     = "https://github.com/JeremySnor/RxMVVM"
  ...
  spec.source       = { :git => "https://github.com/JeremySnor/RxMVVM.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "RxMVVM/Source/**/*.{swift}"
